<?php
    ...
    catch(Exception $e)
    {
     ...
     if( empty($_POST['id']) ){
        ...
        header('Location: ../pages/formulaire_modification_ecrans.php');
        exit;
    }
    else{
        $id = $_POST['id'];
   ...
   $ID_Utilisateurs = $_POST['ID_Utilisateurs'];
    ...
    $requete = $bdd->prepare('UPDATE ecrans SET Marque=:Marque, Modele=:Modele, Date_Achat=:Date_Achat, Duree_Garantie=:Duree_Garantie, ID_Utilisateurs=:ID_Utilisateurs WHERE ID=:ID');
