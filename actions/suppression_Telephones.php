<?php
    ...
    */
    if( empty($_POST['id_telephones']) ){
        // header est utilisé pour rediriger sur une page. 
        header('Location: ../pages/formulaire_suppression_telephones.php');
        exit;
    }
    else{
        $id = $_POST['id_telephones'];
    };


    // Préparation de la requête
    $requete = $bdd->prepare('DELETE FROM telephones WHERE ID=:id');
