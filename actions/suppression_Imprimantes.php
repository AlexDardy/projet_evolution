<?php
    ...
    */
    if( empty($_POST['id_imprimantes']) ){
        // header est utilisé pour rediriger sur une page. 
        header('Location: ../pages/formulaire_suppression_imprimantes.php');
        exit;
    }
    else{
        $id = $_POST['id_imprimantes'];
    };


    // Préparation de la requête
    $requete = $bdd->prepare('DELETE FROM imprimantes WHERE ID=:id');
