            ...
            <div class="row">
                <div class="col-lg">
                    <!-- 
                     ...
                     -->
                    <form action="formulaire_modification_localisation.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_localisation">Choix du bureau à modifier</label>
                            <select id="id_localisation" class="form-control" name="id_localisation">                                
                        ...
                        <button type="submit" class="btn btn-primary">Choisir le bureau</button>
                    </form>

                    <hr>

                    <h1>Formulaire de modification des bureaux</h1>
                    ...
                    <?php 
                        ...
                        /* 
                            ...
                            2) Un article a été choisi et on a donc $_POST['id_localisation'] contenant l'id de l'article, on va pouvoir récupérer l'enregistrement correspondant dans la base de données pour préremplir le formulaire.

                            Pour info, 'id_localisation' correspond à l'attribut "name" de la liste déroulante.
                        */
                        ...
                        */
                        ...
                        /* 
                            Ci-dessous, on va avoir la condition suivante : empty( $_POST['id_localisation'] ) == FALSE
                            
                            Si on la décompose cela donne :
                            $_POST['id_localisation'] correspond à la valeur de l'input "id_localisation" qui a été envoyée par un formulaire au chargement de la page. Si aucun input ne correspond à ce nom, alors $_POST['id_localisation'] sera vide, dans le cas contraire il contiendra la valeur de l'input.
                            ...
                            empty( $_POST['id_localisation] ) signifie donc qu'on va avoir TRUE si $_POST['id_localisation'] est vide ou FALSE s'il contient une valeur.
                            ...
                            Pour résumer, notre condition correspond à la question suivante : "a-t-on une valeur pour un input appelé 'id_localisation' ?"
                        */
                        if( empty($_POST['id_localisation']) == FALSE ){

                            // Si la condition est respectée, on va chercher l'enregistrement correspondant à cet id dans la base de données.
                            
                            // On commence par créer une variable $id_localisation contenant cette valeur
                            $id_localisation = $_POST['id_localisation'];


                            // Préparation de la requête pour récupérer l'enregistrement
                            // Il est important de noter le ":id_localisation", cela correspond à une valeur qu'on va insérer dans la requête par la suite.
                            $requete = $bdd->prepare('SELECT * FROM localisation WHERE Code_Bureau=:id_localisation');
                            

                            // On exécute la requête en lui passant la variable contenant l'id à chercher. Cette valeur sera insérée à la place de :id_localisation dans la requête
                            /*
                            ...
                            */
                            $requete->execute(['id_localisation' => $id_localisation]);
                    ...
                    <form action="../actions/modification_localisation.php" method="POST">
                        ...
                        <!-- 
                            ...
                            On reCode_Bureau également l'attribut "value" qui permet d'indiquer une valeur par défaut, cette valeur par défaut correspond aux variables créées ci-dessus.
                        -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Batiment" name="Batiment" value="<?php echo $Batiment; ?>">
                        </div>

                        <div class="form-group">
                            <label for="Etage">Etage</label>
                            <input type="text" class="form-control" id="Etage" name="Etage" value="<?php echo $Etage; ?>">
                        </div>

                        <div class="form-group">
                            <label for="Bureau">Bureau</label>
                            <input type="text" class="form-control" id="Bureau" name="Bureau" value="<?php echo $Bureau; ?>">
                        </div>

                        <button type="submit" class="btn btn-primary">Modifier la localisation</button>
                    </form>
                </div>
            </div>
