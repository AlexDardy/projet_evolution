...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                <h1>Formulaire de suppression d'utilisateurs</h1>
                    <form action="../actions/suppression_utilisateurs.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_utilisateurs">Choix de l'utilisateur à supprimer</label>
