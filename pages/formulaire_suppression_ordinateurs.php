...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                <h1>Formulaire de suppression d'ordinateurs</h1>
                    <form action="../actions/suppression_Ordinateurs.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_ordinateurs">Choix de l'ordinateur à supprimer</label>
                        ...
                        <button type="submit" class="btn btn-danger">Supprimer l'ordinateur</button>
                    </form>
