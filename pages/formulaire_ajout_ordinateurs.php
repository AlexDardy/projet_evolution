        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    -->
                    <form action="../actions/Ajout_Ordinateurs.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="Taille_disque">Taille du disque</label>
                            <input type="text" class="form-control" id="Taille_disque" name="Taille_disque">
                        </div>

                        <div class="form-group">
                            <label for="Taille_Memoire">Duree de memoire</label>
                            <input type="text" class="form-control" id="Taille_Memoire" name="Taille_Memoire">
                        </div>
