...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Formulaire d'ajout de téléphones</h1>

                    <p>
                        Le formulaire ci-dessous va permettre d'ajouter un téléphone dans la table des téléphones. 
                    </p>
                    ...
                    -->
                    <form action="../actions/Ajout_Telephones.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success">Ajouter un telephone</button>
                    </form>
                </div>
            </div>
