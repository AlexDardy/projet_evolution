...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                <h1>Formulaire de suppression de map role</h1>
                    ...
                    <form action="../actions/suppression_map_role.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_map_role">Choix de map_role à supprimer</label>
                        ...
                        <button type="submit" class="btn btn-danger">Supprimer map_role</button>
                    </form>
