...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Liste des Imprimantes à renouveler</h1>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                */
                                ...
                                $countSql = "SELECT COUNT(ID) FROM ecrans WHERE (DATE_SUB(DATE_ADD(Date_Achat, INTERVAL Duree_Garantie MONTH),INTERVAL 3 MONTH)) < NOW()";
