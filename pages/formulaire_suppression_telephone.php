...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                <h1>Formulaire de suppression de téléphones</h1>
                    <form action="../actions/suppression_telephones.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_telephones">Choix du téléphone à supprimer</label>
                        ...
                        <button type="submit" class="btn btn-danger">Supprimer le telephone</button>
                    </form>
