...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Liste des Telephones</h1>

            <a href="Liste_Telephones_Garantie.php">Afficher les téléphones à renouveler dans les 3 mois</a>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                */
                                ...
                                $countSql = "SELECT COUNT(ID) FROM Telephones";
                                ...
                                $requete = $bdd->prepare('SELECT * FROM Telephones ORDER BY id_utilisateurs
