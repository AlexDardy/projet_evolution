...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Formulaire d'ajout de services</h1>

                    <p>
                        Le formulaire ci-dessous va permettre d'ajouter un service dans la table des services. 
                    </p>
                    ...
                    -->
                    <form action="../actions/Ajout_Services.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success">Ajouter Services</button>
                    </form>
                </div>
            </div>
