            ...
            <div class="row">
                <div class="col-lg">
                    <!-- 
                     ...
                     -->
                    <form action="formulaire_modification_telephones.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_telephones">Choix du téléphone à modifier</label>
                            <select id="id_telephones" class="form-control" name="id_telephones">                                
                        ...
                        <button type="submit" class="btn btn-primary">Choisir le telephone</button>
                    </form>

                    <hr>

                    <h1>Formulaire de modification telephone</h1>
                    ...
                    <?php 
                        ...
                        /* 
                            ...
                            2) Un article a été choisi et on a donc $_POST['id_telephones'] contenant l'id de l'article, on va pouvoir récupérer l'enregistrement correspondant dans la base de données pour préremplir le formulaire.

                            Pour info, 'id_telephones' correspond à l'attribut "name" de la liste déroulante.
                        */
                        ...
                        */
                        ...
                        /* 
                            Ci-dessous, on va avoir la condition suivante : empty( $_POST['id_telephones'] ) == FALSE
                            
                            Si on la décompose cela donne :
                            $_POST['id_telephones'] correspond à la valeur de l'input "id_telephones" qui a été envoyée par un formulaire au chargement de la page. Si aucun input ne correspond à ce nom, alors $_POST['id_telephones'] sera vide, dans le cas contraire il contiendra la valeur de l'input.
                            ...
                            empty( $_POST['id_telephones] ) signifie donc qu'on va avoir TRUE si $_POST['id_telephones'] est vide ou FALSE s'il contient une valeur.
                            ...
                            Pour résumer, notre condition correspond à la question suivante : "a-t-on une valeur pour un input appelé 'id_telephones' ?"
                        */
                        if( empty($_POST['id_telephones']) == FALSE ){

                            // Si la condition est respectée, on va chercher l'enregistrement correspondant à cet id dans la base de données.
                            
                            // On commence par créer une variable $id_telephones contenant cette valeur
                            $id_telephones = $_POST['id_telephones'];


                            // Préparation de la requête pour récupérer l'enregistrement
                            // Il est important de noter le ":id_telephones", cela correspond à une valeur qu'on va insérer dans la requête par la suite.
                            $requete = $bdd->prepare('SELECT * FROM telephones WHERE ID=:id_telephones');
                            

                            // On exécute la requête en lui passant la variable contenant l'id à chercher. Cette valeur sera insérée à la place de :id_telephones dans la requête
                            /*
                            ...
                            */
                            $requete->execute(['id_telephones' => $id_telephones]);
                    ...
                    <form action="../actions/modification_telephones.php" method="POST">
                        ...
                        -->
                        <div class="form-group">
                            <label for="id">Id du téléphone</label>
                            <input type="text" class="form-control" id="id" name="id" value="<?php echo $id_telephones; ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="Duree_Garantie">Durée de garantie</label>
                        ...
                        <button type="submit" class="btn btn-primary">Modifier le telephone</button>
                    </form>
                </div>
            </div>
