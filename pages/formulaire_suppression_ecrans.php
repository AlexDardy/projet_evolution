...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                <h1>Formulaire de suppression d'écrans</h1>
                    

                    <form action="../actions/suppression_ecrans.php" method="post">

                        <!-- Input liste déroulante -->
                        <div class="form-group">
                            <label for="id_ecran">Choix de l'écran à supprimer</label>
                        ...
                        <button type="submit" class="btn btn-danger">Supprimer l'écran</button>
                    </form>
