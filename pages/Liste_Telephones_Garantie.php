...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Liste des Telephones à renouveler</h1>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                */
                                ...
                                $countSql = "SELECT COUNT(ID) FROM telephones WHERE (DATE_SUB(DATE_ADD(Date_Achat, INTERVAL Duree_Garantie MONTH),INTERVAL 3 MONTH)) < NOW()";
